<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmFileSearch.aspx.cs" Inherits="week6.FrmFileSearch" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnExec" runat="server" Text="검색어보기" OnClick="btnExec_Click" PostBackUrl="~/FrmFileSearch.aspx" />
        </div>
    </form>
</body>
</html>
