<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmSearch.aspx.cs" Inherits="week6.FrmSearch" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnExec" runat="server" Text="검색어보기" OnClick="btnExec_Click" PostBackUrl="~/FrmRst.aspx" />
        </div>
    </form>
</body>
</html>
